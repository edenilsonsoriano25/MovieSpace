    ...
    <div class="container-fluid px-4 px-md-5">
        ...
        <div class="edit-page-header">
            <div class="header-left">
                <h1 class="edit-main-title"><i class="fas fa-edit"></i> Editar Película</h1>
                <p class="edit-main-subtitle">Modifica los metadatos, actualiza el estado de las copias físicas o ajusta las tarifas de arriendo.</p>
            </div>
        ...
        <div class="premium-form-card">
            <div class="form-layout-split">
                ...
                <form method="POST" action="{{ route('admin.peliculas.update', $pelicula) }}" class="premium-interactive-form" id="movieEditForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-premium-row">
                        <div class="form-premium-group">
                            ...
                            <input type="text" name="titulo" id="titulo" placeholder="Ej: Batman: El Caballero de la Noche" required value="{{ old('titulo', $pelicula->titulo) }}" oninput="sincronizarTituloHub()">
                            @error('titulo')
                    ...
                    <div class="form-premium-row">
                        <div class="form-premium-group">
                            ...
                            <input type="text" name="director" id="director" placeholder="Ej: Christopher Nolan" required value="{{ old('director', $pelicula->director) }}">
                            @error('director')
                                <div class="field-error-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-premium-group">
                            ...
                            <input type="number" name="año" id="año" placeholder="Ej: 2008" required min="1900" max="2026" value="{{ old('año', $pelicula->año) }}">
                            @error('año')
                                <div class="field-error-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-premium-group">
                        ...
                        <div class="input-action-mix-box">
                            <input type="url" name="portada" id="portada" placeholder="https://ejemplo.com/imagen.jpg" required value="{{ old('portada', $pelicula->portada) }}" oninput="actualizarPrevisualizacionManual()">
                    ...
                    <div class="form-premium-group">
                        ...
                        <textarea name="sinopsis" id="sinopsis" rows="4" placeholder="Escribe o auto-completa la descripción sobre la trama de la película..." required>{{ old('sinopsis', $pelicula->sinopsis) }}</textarea>
                        @error('sinopsis')
                            <div class="field-error-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-premium-row triple-row">
                        <div class="form-premium-group">
                            ...
                            <input type="number" step="0.01" name="precio_alquiler" id="precio_alquiler" placeholder="0.00" required value="{{ old('precio_alquiler', $pelicula->precio_alquiler) }}">
                        ...
                        <div class="form-premium-group">
                            <label for="copias_totales"><i class="fas fa-boxes"></i> Copias Totales en Stock *</label>
                            <input type="number" name="copias_totales" id="copias_totales" placeholder="Ej: 10" required min="1" value="{{ old('copias_totales', $pelicula->copias_totales) }}">
                        ...
                        <div class="form-premium-group">
                            <label for="copias_en_estante"><i class="fas fa-clipboard-check"></i> Copias en Estante (Disponibles) *</label>
                            <input type="number" name="copias_en_estante" id="copias_en_estante" placeholder="Ej: 8" required min="0" value="{{ old('copias_en_estante', $pelicula->copias_en_estante) }}">
                    ...
                    <div class="form-premium-actions">
                        ...
                        <button type="submit" class="btn-form-update">
                ...
                <div class="form-preview-aside">
                    <label class="aside-preview-label"><i class="fas fa-eye"></i> Póster Sincronizado</label>
                    <div class="live-poster-frame">
                        <img id="live-poster-img" src="{{ $pelicula->portada ?: '' }}" alt="Previsualización" style="{{ $pelicula->portada ? 'display: block;' : 'display: none;' }}">
                        <div id="live-poster-placeholder" class="poster-empty-placeholder" style="{{ $pelicula->portada ? 'display: none;' : 'display: flex;' }}">
...
<div id="hub-toast" class="hub-toast-alert">¡Información actualizada exitosamente! 🎯</div>

<style>
    .admin-edit-wrapper { background-color: #0f1115; min-height: 100vh; margin-top: -2rem; padding: 3rem 0 5rem 0; color: #ffffff; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
    .edit-page-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 3rem; gap: 1.5rem; }
    .edit-main-title { font-size: 2.6rem; font-weight: 800; margin: 0 0 0.4rem 0; background: linear-gradient(45deg, #ff416c, #ff4b2b); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    .edit-main-title i { color: #ff4b2b; -webkit-text-fill-color: initial; margin-right: 12px; }
    .edit-main-subtitle { color: #6c757d; font-size: 0.98rem; margin: 0; }
