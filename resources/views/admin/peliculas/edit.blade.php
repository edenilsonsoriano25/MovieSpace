...
<div class="admin-edit-wrapper">
    <div class="container-fluid px-4 px-md-5">
        ...
        <div class="premium-form-card">
            <form method="POST" action="{{ route('admin.peliculas.update', $pelicula) }}" class="premium-interactive-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-premium-row">
                    <div class="form-premium-group">
                        ...
                        <input type="text" name="titulo" id="titulo" placeholder="Ej: Batman: El Caballero de la Noche" required value="{{ old('titulo', $pelicula->titulo) }}">
                        @error('titulo')
                ...
                <div class="form-premium-group">
                    ...
                    <textarea name="sinopsis" id="sinopsis" rows="4" placeholder="Escribe una breve descripción sobre la trama de la película..." required>{{ old('sinopsis', $pelicula->sinopsis) }}</textarea>
                    @error('sinopsis')
                        <div class="field-error-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
...
<style>
    ...
    /* Inyección de Flecha en el Select */
    ...
    @media (max-width: 768px) {
        .edit-page-header { flex-direction: column; align-items: flex-start; gap: 1rem; }
        ...
        .btn-form-update, .btn-form-cancel { flex: 1; text-align: center; justify-content: center; }
    }
</style>
@endsection